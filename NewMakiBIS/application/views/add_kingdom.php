<div class="main_content" style="font-size:13px">
    ...
    <?php echo form_open('user/submit_kingdom');?>
	...
	<!--<label>Sub-species: </label><br/>
  	...
  	<?php echo form_input(array('id'=>'kingdom', 'name'=>'kingdom', 'value'=>set_value('kingdom'), 'class'=>'text ui-state-default ui-corner-all'));?><br/><br/>
