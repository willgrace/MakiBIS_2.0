<div class="main_content" style="font-size:13px">
    ...
    <?php echo form_open('user/submit_order');?>
	...
	<!--<label>Sub-species: </label><br/>
  	...
  	<?php echo form_input(array('id'=>'order_name', 'name'=>'order_name', 'value'=>set_value('order_name'), 'class'=>'text ui-state-default ui-corner-all'));?><br/><br/>
