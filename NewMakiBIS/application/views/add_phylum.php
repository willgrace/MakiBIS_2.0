<div class="main_content" style="font-size:13px">
    ...
    <?php echo form_open('user/submit_phylum');?>
	...
	<!--<label>Sub-species: </label><br/>
  	...
  	<?php echo form_input(array('id'=>'phylum', 'name'=>'phylum', 'value'=>set_value('phylum'), 'class'=>'text ui-state-default ui-corner-all'));?><br/><br/>
